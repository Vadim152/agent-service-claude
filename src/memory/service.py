...
class MemoryService:
    ...
    def record_generation_review(
        ...
        *,
        ...
        final_then_lines: list[str] | None = None,
        ...
        history.append(
            {
                ...
                "rejectedCandidateIds": list(rejected_candidate_ids or []),
                "bindingDecisions": list(binding_decisions or []),
                "confirmedClarifications": dict(confirmed_clarifications or {}),
                "finalThenLines": list(final_then_lines or []),
